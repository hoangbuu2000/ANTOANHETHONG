                ...
                <div class="col-lg-8 offset-lg-2">
                    <form>
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <label><spring:message code="schedule.add.label.doctor" /> <span
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><spring:message code="schedule.add.label.date" /> <span
                                            class="text-danger">*</span></label>
                                    <div class="cal-icon">
                                        <form:input onchange="pickDate(this)" onmouseout="pickDate(this)" path="ngayKham" cssClass="form-control datetimepicker" value="${ngayKham}" />
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-6">
                                        <div class="form-group">
                                            <label><spring:message code="schedule.add.label.shift" /> <span
                                                    class="text-danger">*</span></label>
                                            <form:select path="caKhamBenh" cssClass="form-control select">
                                                <form:option value="${schedule.caKhamBenh.id}" label="${schedule.caKhamBenh.tenCa}"/>
                                            </form:select>
                        ...
                        <div class="m-t-20 text-center">
                            <button class="btn btn-primary submit-btn"><spring:message code="schedule.edit.form.submit" /></button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function pickDate(obj) {
        if (obj.value != "" && moment(obj.value, "DD/MM/YYYY").isValid()) {
            ...
            caKham.append(new Option("${label}", ""));
