    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title"><spring:message code="appointment.add.page.title"/></h4>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.first"/> <span
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.last"/> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.age"/> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.email"/> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.dob"/> <span
                                        class="text-danger">*</span></label>
                                <div class="cal-icon">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group gender-select">
                                <label class="gen-label"><spring:message code="patient.add.label.gender"/> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.phone"/> <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.appointment"/> <span
                                        class="text-danger">*</span></label>
                                <div class="cal-icon">
                                    <form:input onchange="pickDate(this)" onmouseout="pickDate(this)" path="ngayKham"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.shift"/> <span
                                        class="text-danger">*</span></label>
                                <form:select onchange="getJson()" path="caKham" cssClass="form-control select">
                                    <form:option value=""><spring:message code="patient.add.label.shift.msg" /></form:option>
                                </form:select>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <form:select path="bacSi" cssClass="form-control select">
                                    <form:option value=""><spring:message code="patient.add.label.doctor.msg" /></form:option>
                                </form:select>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.disease"/> <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary submit-btn"><spring:message
                                code="appointment.add.form.submit"/></button>
                    </div>
                </div>
            </div>
        </form:form>
...
<script>
    <c:set var="labelDoctor">
        <spring:message code="patient.add.label.doctor.msg"/>
    </c:set>
    <c:set var="labelShift">
    <spring:message code="patient.add.label.shift.msg"/>
    </c:set>
    ...
    function getJson() {
        ...
        bacSi.append(new Option("${labelDoctor}", ""));
    ...
    function getJson1(caKham, ngayKham) {
        caKham.append(new Option("${labelShift}", ""));
