...
<div class="page-wrapper">
    <div class="content">
        ...
        <form:form id="form-pres" onsubmit="return false;" modelAttribute="prescription" method="post">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="prescription.add.label.patient"/> <span
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="prescription.add.label.disease"/> <span
                                        class="text-danger">*</span></label>
                                <c:if test="${prescription.id != null}">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="prescription.add.label.date"/> <span
                                        class="text-danger">*</span></label>
                                <div class="cal-icon">
                                    <c:if test="${prescription.id != null}">
                        ...
                        <table id="table_medicine" class="table table-responsive-md">
                            ...
                            <tr>
                                ...
                                <td><spring:message code="prescription.add.table.medicine.name"/> <span
                                        class="text-danger">*</span></td>
                                <td><spring:message code="prescription.add.table.medicine.quantity"/> <span
                                        class="text-danger">*</span></td>
                            ...
                            <c:if test="${prescription.id != null}">
                                ...
                                <c:forEach items="${prescription.medicines.entrySet()}" var="set">
                                    <tr>
                                        ...
                                        <td id="select${i}">
                                            <select id="${i}" name="medicine" onchange="getUnitAndPrice(this)"
                                                    class="medicine" class="form-control select">
                                                <option value="0"><spring:message
                                                        code="prescription.add.table.medicine.select.label"/></option>
                                        ...
                                        <td id="td_quantity${i}">
                                            <input id="quantity${i}" name="quantity" onchange="tinhTien(this)"
                                                   class="quantity"
                            ...
                            <c:if test="${prescription.id == null}">
                                <tr>
                                    ...
                                    <td id="select1">
                                        <select id="1" name="medicine" onchange="getUnitAndPrice(this)" class="medicine"
                                    ...
                                    <td id="td_quantity1">
                                        <input id="quantity1" required name="quantity" onchange="tinhTien(this)"
                                               class="quantity" type="number" min="1" class="form-control"/>
                                    </td>
                                    <td class="unit"></td>
                                    <td class="price"></td>
                                    <td class="total"></td>
                    ...
                    <div class="m-t-20 text-center">
                        ...
                        <c:if test="${prescription.id != null}">
                            <button onclick="getDataBeforeSubmit()" class="btn btn-primary submit-btn"><spring:message
                                    code="prescription.edit.form.submit"/></button>
                        </c:if>
                        <c:if test="${prescription.id == null}">
                            <button onclick="getDataBeforeSubmit()" class="btn btn-primary submit-btn"><spring:message
                                    code="prescription.add.form.submit"/></button>
                        </c:if>
                    </div>
                </div>
            </div>
    ...
    function getDataBeforeSubmit() {
        ...
        if (str != "") {
            ...
            if (dem > 0) {
                ...
                document.querySelector("#form-pres").submit();
            }
        }
