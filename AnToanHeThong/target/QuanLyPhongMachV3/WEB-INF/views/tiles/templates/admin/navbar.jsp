...
<div class="header">
    ...
    <ul class="nav user-menu float-right">
        <li style="padding-top: 15px; margin-right: 10px">
            <form id="form-lang" action="">
                <c:if test="${param.id != null}">
                    <input type="hidden" name="id" value="${param.id}"/>
                </c:if>
                <c:if test="${param.oldPatient != null}">
                    <input type="hidden" name="oldPatient" value="${param.oldPatient}"/>
                </c:if>
                <select onchange="selectLang(this)" name="lang" id="">
                    ...
                    (param.lang != 'vi' && param.lang != 'en' && param.lang != 'ja')}">
                        <option value="">language</option>
                        <option value="en">english</option>
                        <option value="vi">vietnamese</option>
                        <option value="ja">japanese</option>
...
<script>
    function selectLang(obj) {
        let form = document.getElementById("form-lang");
        if (obj.value != "") {
            form.submit();
        }
    }
