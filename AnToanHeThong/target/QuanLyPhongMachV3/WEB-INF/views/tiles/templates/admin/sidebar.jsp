    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <c:if test="${!param.lang.isEmpty() && param.lang != null}">
                ...
                <c:choose>
                    <c:when test="${pageContext.request.isUserInRole('ROLE_ADMIN')}">
                        ...
                        <li class="${dashboard}">
                            <a href="<c:url value="/admin${lang}" />"><i class="fa fa-dashboard"></i> <span><spring:message code="ul.dashboard" /></span></a>
                        </li>
                        <li class="${admin}">
                            <a href="<c:url value="/admin/admin-management${lang}" />"><i class="fa fa-star"></i> <span><spring:message code="ul.admin" /></span></a>
                        </li>
                        <li class="${doctor}">
                            <a href="<c:url value="/admin/doctor${lang}" />"><i class="fa fa-user-md"></i> <span><spring:message code="ul.doctor" /></span></a>
                        </li>
                        <li class="${patient}">
                            <a href="<c:url value="/admin/patient${lang}" />"><i class="fa fa-wheelchair"></i> <span><spring:message code="ul.patient" /></span></a>
                        </li>
                        <li class="${appointment}">
                            <a href="<c:url value="/admin/appointment${lang}" />"><i class="fa fa-calendar"></i> <span><spring:message code="ul.appointment" /></span></a>
                        </li>
                        <li class="${schedule}">
                            <a href="<c:url value="/admin/schedule${lang}" />"><i class="fa fa-calendar-check-o"></i> <span><spring:message code="ul.schedule" /></span></a>
                        </li>
                        <li class="${disease}">
                            <a href="<c:url value="/admin/disease${lang}" />"><i class="fa fa-deaf"></i> <span><spring:message code="ul.disease" /></span></a>
                        </li>
                        <li class="${medicine}">
                            <a href="<c:url value="/admin/medicine${lang}" />"><i class="fa fa-eject"></i> <span><spring:message code="ul.medicine" /></span></a>
                        </li>
                        <li class="${prescription}">
                            <a href="<c:url value="/admin/prescription${lang}" />"><i class="fa fa-heartbeat"></i> <span><spring:message code="ul.prescription" /></span></a>
                        </li>
                        <li class="${invoice}">
                            <a href="<c:url value="/admin/invoice${lang}" />"><i class="fa fa-hospital-o"></i> <span><spring:message code="ul.invoice" /></span></a>
                        </li>
                        <li class="${employee}">
                            <a href="<c:url value="/admin/employee${lang}" />"><i class="fa fa-user-plus"></i> <span><spring:message code="ul.employee" /></span></a>
                        </li>
                        <li class="submenu">
                            ...
                            <ul style="display: ${display}">
                                <li class="${chart_doctors}"><a href="<c:url value="/admin/chart/doctors${lang}" />"><spring:message code="ul.doctor" /></a></li>
                                <li class="${chart_patients}"><a href="<c:url value="/admin/chart/patients${lang}" />"><spring:message code="ul.patient" /></a></li>
                                <li class="${chart_sales}"><a href="<c:url value="/admin/chart/sales${lang}" />"><spring:message code="ul.sales" /></a></li>
                            </ul>
                        </li>
<%--                        <li class="submenu">--%>
