...
<div class="page-wrapper" style="padding-top: 155px">
    <div class="content">
        <form:form id="form-appointment" onsubmit="return false;" method="post" role="form" cssClass="lead" modelAttribute="patient">
            ...
            <input type="submit" value="Submit" class="btn btn-skin btn-block btn-lg" onclick="checkPayment()">
