    ...
    <div class="content">
        ...
        <c:if test="${diseases.size() > 0}">
            <table class="table table-response-md">
                <thead>
                <tr>
                    <!--Modal chi tiet toa thuoc -->
                    <th><spring:message code="patient.details.pres.id" /></th>
                    <th><spring:message code="patient.details.pres.date" /></th>
                    <th><spring:message code="patient.details.pres.disease" /></th>
                    <th><spring:message code="patient.details.pres.description" /></th>
                    <th><spring:message code="patient.details.pres.doctor" /></th>
                </tr>
                </thead>
                <tbody>
        ...
        <c:if test="${diseases.size() <= 0}">
            <div class="alert-danger">
                <h4><spring:message code="patient.details.never.msg" /></h4>
            </div>
        </c:if>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="detailsTitle"><spring:message code="patient.details.modal.title" /></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <h4><spring:message code="patient.details.modal.heading" /></h4>
                        <table id="table-modal" class="table table-responsive-md">
                            ...
                            <tr>
                                ...
                                <th><spring:message code="patient.details.modal.table.thead.description" /></th>
                            ...
                            <tfoot>
                            <tr>
                                <td colspan="6"><spring:message code="patient.details.modal.table.thead.total.medicines" /></td>
                                <td colspan="1"><spring:message code="patient.details.modal.table.thead.total.default" /></td>
                            </tr>
                            <tr>
                                <td colspan="6"><spring:message code="patient.details.modal.table.thead.total.disease" /></td>
                                <td colspan="1"><spring:message code="patient.details.modal.table.thead.total.default" /></td>
                            </tr>
                            <tr>
                                <td colspan="6"><spring:message code="patient.details.modal.table.thead.total" /></td>
                                <td colspan="1"><spring:message code="patient.details.modal.table.thead.total.default" /></td>
                            </tr>
                            </tfoot>
                        </table>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal"><spring:message code="patient.details.modal.close" /></button>
                    </div>
                </div>
            </div>
        </div>
