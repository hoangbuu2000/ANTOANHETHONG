        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.appointment" /> <span class="text-danger">*</span></label>
                                <div class="cal-icon">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.shift" /> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.doctor" /> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="patient.add.label.disease" /> <span class="text-danger">*</span></label>
