        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="add.body.label.last" /> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="add.body.label.dob" /> <span class="text-danger">*</span></label>
                                <div class="cal-icon">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group gender-select">
                                <label class="gen-label"><spring:message code="add.body.label.gender" /> <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label><spring:message code="add.body.label.phone" /> <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="profile-upload">
                                    <div class="upload-img">
                                        <img alt="" src="<c:url value="${doctor.urlImg}" />" />
                                    </div>
