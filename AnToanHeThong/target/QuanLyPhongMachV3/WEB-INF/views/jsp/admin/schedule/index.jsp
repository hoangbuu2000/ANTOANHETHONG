    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="<c:url value="/admin/schedule/add${lang}" />" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> <spring:message code="schedule.index.add" /></a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <c:forEach items="${schedules}" var="s">
                            ...
                            <tr id="${s.bacSi.id}${s.caKhamBenh.id}${date}">
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <c:if test="${user.role.ten.equals('ROLE_ADMIN')}">
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="<c:url value="/admin/schedule/edit/${s.bacSi.id}/${s.caKhamBenh.id}/${date}${lang}" />"><i class="fa fa-pencil m-r-5"></i> <spring:message code="schedule.index.table.action.edit" /></a>
                                    ...
                                    <form:form action="/admin/schedule/delete/${s.bacSi.id}/${s.caKhamBenh.id}/${date}${lang}" method="post">
                                    <div id="delete_schedule${s.bacSi.id}${s.caKhamBenh.id}${date}" class="modal fade delete-modal" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body text-center">
                                                    <h3><spring:message code="schedule.index.table.action.delete.msg" /></h3>
                                                    <div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal"><spring:message code="schedule.index.table.action.closes" /></a>
                                                            <button type="submit" class="btn btn-danger"><spring:message code="schedule.index.table.action.delete" /></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
