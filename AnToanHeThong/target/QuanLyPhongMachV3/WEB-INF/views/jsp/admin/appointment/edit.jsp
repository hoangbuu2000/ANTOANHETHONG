    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h4 class="page-title"><spring:message code="appointment.edit.page.title" /></h4>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="m-t-20 text-center">
                        <button class="btn btn-primary submit-btn"><spring:message code="appointment.edit.form.submit" /></button>
                    </div>
                </div>
            </div>
        </form:form>
