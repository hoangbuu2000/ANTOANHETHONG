    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-4 col-3">
                <h4 class="page-title"><spring:message code="admin.index.page.title" /></h4>
            </div>
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="<c:url value="/admin/admin-management/add${lang}" />" class="btn btn-primary float-right btn-rounded"><i
                        class="fa fa-plus"></i> <spring:message code="admin.index.add" /></a>
            </div>
        </div>
        <div class="row filter-row">
            <div class="col-sm-6 col-md-3">
                <div class="form-group form-focus">
                    <label class="focus-label"><spring:message code="admin.index.table.id" /></label>
                    <input id="adID" name="adID" type="text" class="form-control floating">
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
                <div class="form-group form-focus">
                    <label class="focus-label"><spring:message code="admin.index.table.name" /></label>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-border table-striped custom-table datatable mb-0 dataTable no-footer"
                        ...
                        <thead>
                        <tr>
                            <th style="min-width:200px;"><spring:message code="admin.index.table.name" /></th>
                            <th><spring:message code="admin.index.table.id" /></th>
                            <th><spring:message code="admin.index.table.email" /></th>
                            <th><spring:message code="admin.index.table.mobile" /></th>
                            <th style="min-width: 110px;"><spring:message code="admin.index.table.joinDate" /></th>
                            <th class="text-right"><spring:message code="admin.index.table.action" /></th>
                        </tr>
                        </thead>
                        <tbody>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="<c:url value="/admin/admin-management/edit/${e.id}${lang}" />"><i
                                                    class="fa fa-pencil m-r-5"></i> <spring:message code="admin.index.table.action.edit" /></a>
                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                               data-target="#delete_admin${e.id}"><i class="fa fa-trash-o m-r-5"></i>
                                                <spring:message code="admin.index.table.action.delete" /></a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body text-center">
                                                    <h3><spring:message code="admin.index.table.action.delete.msg" /></h3>
                                                    <div class="m-t-20"><a href="#" class="btn btn-white"
                                                                           data-dismiss="modal"><spring:message code="admin.index.table.action.close" /></a>
                                                        <a href="javascript:;" onclick="deleteAjax('${e.id}')" class="btn btn-danger" data-dismiss="modal"><spring:message code="admin.index.table.action.delete" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            for (let i = 0; i < ds.length; i++) {
                ...
                if (ds[i].id != null) {
                    ...
                    $('#DataTables_Table_0').find('tbody').append(
                        ...
                        '<div class="modal-content">' +
                        '<div class="modal-body text-center">' +
                        '<h3><spring:message code="admin.index.table.action.delete.msg"/> (' + ds[i].ten + ')?</h3>' +
